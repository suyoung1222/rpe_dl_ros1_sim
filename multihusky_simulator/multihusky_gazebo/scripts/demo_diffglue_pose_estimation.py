...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--resize', type=int, nargs='+', default=[800],
    ...
    # Load the image pair.
    start_pre = time.time()
    image0, inp0, scales0 = read_image('../bagfiles/loop1_robot1/1744928847.735512.png', device, opt.resize) # Follower
    image1, inp1, scales1 = read_image('../bagfiles/loop1_robot2/1744928847.723895.png', device, opt.resize) # Leader
    end_pre = time.time()
