...
def main():
    ...
    parser.add_argument('--resize', type=int, nargs='+', default=[320, 240])
    ...
    depth_img1 = depth_img1.astype(np.float32) / 5000.0 #1000000.0  # convert mm->m
